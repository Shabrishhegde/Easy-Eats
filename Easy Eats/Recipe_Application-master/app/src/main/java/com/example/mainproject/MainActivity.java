...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //italian soup
        courseList.add(new Course(1, "tomato", "Italian tomato\nsoup", "~ 30\nminutes        ","Average\ndifficulty","#C81818","www.youtube.com/watch?v=a7HusM6I-Cw&ab_channel=Natalie%27sCookingShow",
                "Ingredients\n" +
        ...
        //kfc
        courseList.add(new Course(2, "kfc","KFC chicken\nstrips","~ 40\nminutes        ","Average\ndifficulty","#9FA52D","www.youtube.com/watch?v=2E_N5rCjCWw&ab_channel=Recipesoftheworld",
                "INGREDIENTS\n" +
                        "\n" +
        ...
        courseList.add(new Course(3, "borsh", "Russian soup\nborsch", "~ 50\nminutes        ","Average\ndifficulty","#A52B2B","www.youtube.com/watch?v=YYCDBKreJBo&ab_channel=WorldFood4u",
                "INGREDIENTS\n" +
                        "For the soup:\n" +
        ...
        courseList.add(new Course(4, "onionsoup", "French onion\nsoup", "~ 1 hour 30\nminutes      ","Difficult\ncomplexity","#CB8D16","www.youtube.com/watch?v=1qRir364aNk&ab_channel=BabishCulinaryUniverse",
                "Ingredients\n" +
                        "\n"+
        ...
        courseList.add(new Course(5, "parmesanchicken", "Parmesan Chicken\nBake", "~ 30\nminutes        ","a bit\ndifficult","#DEAD00","www.youtube.com/watch?v=ZrR0VbqNdW8&ab_channel=BabishCulinaryUniverse",
                "Ingredients\n" +
                ...
                ,2));
        //Fast food 2 burger
        courseList.add(new Course(6, "burger", "Olly's 'thank you'\nFinest burgers", "~ 50\nminutes        ","Average\ndifficulty","#EEA83E","www.youtube.com/watch?v=P7qZC2hLaE0&ab_channel=Tesco",
                ...
                ,3));
        //4. Pasty
        courseList.add(new Course(7, "cornishpasty", "Cornish\npasty", "~ 1 h\n20 min        ","Average\ndifficulty","#FF7070","www.youtube.com/watch?v=JsZCkBH7v2k&ab_channel=FoodWishes",
                "Ingredients\n" +
                        "For the pastry\n" +
        ...
        //5. Biscuits
        courseList.add(new Course(8, "purpose", "All-Purpose\nBiscuits", "~ 1\nhour              ","Average\ndifficulty","#945B38","www.youtube.com/watch?v=HIftxfzFakc&ab_channel=Allrecipes",
                "Ingredients\n" +
        ...
        //6. Cakes
        courseList.add(new Course(9, "vanillacake", "The Best Vanilla\nCake", "~ 4\nhour              ","a bit\ndifficult","#690004","www.youtube.com/watch?v=9wr8an7mjlc&ab_channel=ButtercutBakery",
                "Ingredients\n" +
        ...
        //7. Pizza
        courseList.add(new Course(10, "margarita", "Pizza\nMargherita", "~ 35\nminutes        ","Average\ndifficulty","#FC9211","www.youtube.com/watch?v=az5D8C6K5Dk&ab_channel=Tasty",
                "Ingredients\n" +
                        "For the base\n" +
        ...
        //8. Other
        courseList.add(new Course(11, "irish", "Irish Mashed\nPotatoes", "~ 35\nminutes        ","Average\ndifficulty","#717C08","www.youtube.com/results?search_query=Irish+Mashed+Potatoes",
                "Ingredients\n" +
        ...
        //1. Soups
        courseList.add(new Course(12, "chicken", "Chicken\nsoup", "~ 50\nminutes        ","Average\ndifficulty","#D1AD19","www.youtube.com/watch?v=PpOzKgLhU1I&ab_channel=KevinIsCooking",
                "Ingredients\n" +
        ...
        //2. Main Dish
        courseList.add(new Course(13, "turkey", "Turkey\nà la King", "~ 25\nminutes        ","Average\ndifficulty","#0785AC","www.youtube.com/watch?v=afUXjCWuUTM&ab_channel=BlackstoneGriddles",
                "Ingredients\n" +
        ...
        //3. Fast
        courseList.add(new Course(14, "taco", "The Best\nHomemade Tacos", "~ 20\nminutes        ","Average\ndifficulty","#EFB269","www.youtube.com/watch?v=6ymqq6rVSxg&ab_channel=Smokin%27%26GrillinwithAB",
                "Ingredients\n" +
                        " \n" +
        ...
        //4. Pasty
        courseList.add(new Course(15, "bakewell", "Mini bakewell\ntarts", "~ 40\nminutes        ","Average\ndifficulty","#BE3B3D","www.youtube.com/watch?v=ju_ND6s4EA4&ab_channel=Waitrose%26Partners",
                "Ingredients\n" +
        ...
        //5. Biscuits
        courseList.add(new Course(16, "cookie", "Easy\nbiscuits", "~ 20\nminutes        ","Average\ndifficulty","#875411","www.youtube.com/watch?v=pt8A1cULe2E&ab_channel=FitwaffleKitchen",
                "Ingredients\n" +
        ...
        //6. Cakes
        courseList.add(new Course(17, "napoleon", "Best Napoleon\nCake Ever", "~ 40\nminutes        ","Average\ndifficulty","#F3A56B","www.youtube.com/watch?v=LdhcIlf6EAs&ab_channel=SimplyHomeCooked",
                "Ingredients\n" +
        ...
        //7. Pizza
        courseList.add(new Course(18, "pepperoni", "Pepperoni\npizza", "~ 40\nminutes        ","Average\ndifficulty","#E26804","www.youtube.com/watch?v=HCAPjIVOdJw&ab_channel=CroutonCrackerjacks",
                "Ingredients\n" +
        ...
        //8. Other
        courseList.add(new Course(19, "ragu", "Wild boar ragù\nwith fresh pasta", "~ 2\nhours             ","Average\ndifficulty","#DB5205","www.youtube.com/watch?v=0nPKzOHUIXw&ab_channel=Vincenzo%27sPlate",
                "Ingredients\n" +
                        "For the ragú\n" +
        ...
        //2. Main Dish
        courseList.add(new Course(20, "potato", "Braised fingerling\npotatoes", "~ 40\nminutes        ","Average\ndifficulty","#CA6E01","www.youtube.com/watch?v=kQuxsswGY5g&ab_channel=America%27sTestKitchen",
                "Ingredients\n" +
        ...
        //3. Fast
        courseList.add(new Course(21, "twisties", "Crunchy Chicken\nTwisties drumsticks", "~ 45\nminutes        ","Average\ndifficulty","#EFB724","www.youtube.com/watch?v=zator5PSTcM&ab_channel=RecipeTinEats",
                "Ingredients\n" +
        ...
        //4. Pasty
        courseList.add(new Course(22, "chocolatechip", "Chocolate Chip\nBlondies", "~ 20\nminutes        ","Average\ndifficulty","#3D1D13","www.youtube.com/watch?v=2uGgQUc6TZA&ab_channel=YummyTreats",
                "Ingredients\n" +
        ...
        //5. Biscuits
        courseList.add(new Course(23, "basicbis", "Basic butter\nbiscuit dough", "~ 40\nminutes        ","Average\ndifficulty","#D1A3A8","www.youtube.com/watch?v=iKXd87s5Ih4&ab_channel=HebbarsKitchen",
                "7 Ingredients\n" +
                        "\n" +
        ...
        //6. Cakes
        courseList.add(new Course(24, "sponge", "Sponge\ncake", "~ 30\nminutes        ","Average\ndifficulty","#AA5B2A","www.youtube.com/watch?v=yrzOQ2Ssqnw&ab_channel=PiyasKitchen",
                "Ingredients\n" +
        ...
        //7. Pizza
        courseList.add(new Course(25, "rpizza", "Pizza\nDough", "~ 2 hrs 30\nminutes        ","Average\ndifficulty","#E1734C","www.youtube.com/watch?v=C-mV_xILah8&ab_channel=FlavoursOfFood",
                "Ingredients\n" +
        ...
        //8. Other
        courseList.add(new Course(26, "irishend", "Irish Beef\nStew", "~ 2 hrs 15\nminutes        ","Average\ndifficulty","#9F610A","www.youtube.com/watch?v=uTEHlpyJ_kM&ab_channel=RecipeTinEats",
                "Ingredients\n" +
